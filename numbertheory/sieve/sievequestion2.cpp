...
void createsieve()
{
    ...
    // count[n]will have the answer for the required query/
}
// below is the another way of the above approach as we are
//  not taking another array to store the counts we are updating in sieve arrray itself
int main()
{
    int t;
    cin >> t;
